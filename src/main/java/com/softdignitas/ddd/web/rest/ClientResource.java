...
/**
 * REST controller for managing {@link com.softdignitas.ddd.domain.Client}.
 */
@RestController
...
public class ClientResource extends DDDEntitateResource<Client> {
    ...
    public ResponseEntity<Client> partialUpdateClient(
        ...
        Optional<Client> result = clientRepository
            ...
            .map(existingClient -> {
                if (client.getDenumire() != null) {
                    existingClient.setDenumire(client.getDenumire());
                }
                if (client.getCodFiscal() != null) {
                    existingClient.setCodFiscal(client.getCodFiscal());
                }
                if (client.getNumarRegistruComert() != null) {
                    existingClient.setNumarRegistruComert(client.getNumarRegistruComert());
                }
                if (client.getAdresaPunctLucru() != null) {
                    existingClient.setAdresaPunctLucru(client.getAdresaPunctLucru());
                }
                ...
                if (client.getPersoanaContact() != null) {
                    existingClient.setPersoanaContact(client.getPersoanaContact());
                }
                if (client.getContract() != null) {
                    existingClient.setContract(client.getContract());
                }
                if (client.getDeratizare() != null) {
                    existingClient.setDeratizare(client.getDeratizare());
                }
                if (client.getDezinsectie() != null) {
                    existingClient.setDezinsectie(client.getDezinsectie());
                }
                if (client.getDezinfectie() != null) {
                    existingClient.setDezinfectie(client.getDezinfectie());
                }
                if (client.getFrecventaDeratizare() != null) {
                    existingClient.setFrecventaDeratizare(client.getFrecventaDeratizare());
                }
                if (client.getFrecventaDezinsectie() != null) {
                    existingClient.setFrecventaDezinsectie(client.getFrecventaDezinsectie());
                }
                if (client.getFrecventaDezinfectie() != null) {
                    existingClient.setFrecventaDezinfectie(client.getFrecventaDezinfectie());
                }
