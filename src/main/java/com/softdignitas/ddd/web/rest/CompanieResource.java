...
public class CompanieResource {
    ...
    public ResponseEntity<Companie> updateCompanie(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, companie.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Companie> partialUpdateCompanie(
        ...
        Optional<Companie> result = companieRepository
            ...
            .map(existingCompanie -> {
                if (companie.getiD() != null) {
                    existingCompanie.setiD(companie.getiD());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, companie.getId().toString())
        );
    }
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Companie> getCompanie(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteCompanie(@PathVariable("id") Long id) {
