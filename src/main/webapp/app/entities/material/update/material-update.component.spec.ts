...
describe('Material Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Companie query and add missing value', () => {
      ...
      const companie: ICompanie = { id: '4f324a12-d98c-4803-955e-a920c84b1abf' };
      material.companie = companie;

      const companieCollection: ICompanie[] = [{ id: 'e387a782-bce9-44da-90da-560757e0744a' }];
    ...
    it('Should update editForm', () => {
      const material: IMaterial = { id: 'CBA' };
      const companie: ICompanie = { id: '3eb28b9a-4089-4975-9668-0e529a8cda3f' };
      material.companie = companie;
